...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-investigations']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-investigations': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-investigations']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-investigations': maximum cardinality of 'extension' is 1</sch:assert>
