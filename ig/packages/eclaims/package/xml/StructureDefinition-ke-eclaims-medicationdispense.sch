...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:statusReason[x] 1</sch:title>
    <sch:rule context="f:MedicationDispense/f:statusReason[x]">
      <sch:assert test="count(f:coding) &gt;= 1">coding: minimum cardinality of 'coding' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:statusReason[x]/f:coding 1</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense/f:dosageInstruction">
      ...
      <sch:assert test="count(f:patientInstruction) &gt;= 1">patientInstruction: minimum cardinality of 'patientInstruction' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:dosageInstruction/f:asNeeded[x] 1</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:dosageInstruction/f:asNeeded[x]/f:coding 1</sch:title>
    <sch:rule context="f:MedicationDispense/f:dosageInstruction/f:asNeeded[x]/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:dosageInstruction/f:doseAndRate/f:type</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationDispense/f:dosageInstruction/f:doseAndRate/f:type/f:coding</sch:title>
    <sch:rule context="f:MedicationDispense/f:dosageInstruction/f:doseAndRate/f:type/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
