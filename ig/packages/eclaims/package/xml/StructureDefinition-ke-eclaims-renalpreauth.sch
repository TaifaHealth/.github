...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-session-expected-date']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-session-expected-date': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-session-expected-date']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-session-expected-date': maximum cardinality of 'extension' is 1</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-vital-signs']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-vital-signs': minimum cardinality of 'extension' is 1</sch:assert>
