...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-carcinoma-staging']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-carcinoma-staging': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-carcinoma-staging']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-carcinoma-staging': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-metastases']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-metastases': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-metastases']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-metastases': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-treatment-setting']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-treatment-setting': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-treatment-setting']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-treatment-setting': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-cost-per-session']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-cost-per-session': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-cost-per-session']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-cost-per-session': maximum cardinality of 'extension' is 1</sch:assert>
