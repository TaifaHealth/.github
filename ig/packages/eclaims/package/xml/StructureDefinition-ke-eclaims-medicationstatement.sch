...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:statusReason</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:statusReason/f:coding</sch:title>
    <sch:rule context="f:MedicationStatement/f:statusReason/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:MedicationStatement/f:reasonCode/f:coding</sch:title>
