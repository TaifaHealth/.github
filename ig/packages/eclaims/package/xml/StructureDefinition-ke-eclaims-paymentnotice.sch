...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile PaymentNotice
  ...
  <sch:pattern>
    <sch:title>f:PaymentNotice/f:meta</sch:title>
    <sch:rule context="f:PaymentNotice/f:meta">
  ...
  <sch:pattern>
    <sch:title>f:PaymentNotice/f:identifier</sch:title>
    <sch:rule context="f:PaymentNotice/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PaymentNotice/f:amount</sch:title>
    <sch:rule context="f:PaymentNotice/f:amount">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:value) &gt;= 1">value: minimum cardinality of 'value' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:PaymentNotice/f:paymentStatus</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:PaymentNotice/f:paymentStatus/f:coding</sch:title>
    <sch:rule context="f:PaymentNotice/f:paymentStatus/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
