...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-patient-invoice']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-patient-invoice': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-patient-invoice']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-patient-invoice': maximum cardinality of 'extension' is 1</sch:assert>
