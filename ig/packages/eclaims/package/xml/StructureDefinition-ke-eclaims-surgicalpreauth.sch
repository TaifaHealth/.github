...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-anaesthesia-type']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-anaesthesia-type': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-anaesthesia-type']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-anaesthesia-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-chief-complaint']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-chief-complaint': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-chief-complaint']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-chief-complaint': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-clinical-indications']) &gt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-clinical-indications': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-clinical-indications']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-clinical-indications': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-vital-signs']) &lt;= 1">extension with URL = 'https://fhir.dha.go.ke/ig/eclaims/StructureDefinition/eclaims-vital-signs': maximum cardinality of 'extension' is 1</sch:assert>
