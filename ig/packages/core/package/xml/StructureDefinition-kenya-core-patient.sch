...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.sha.go.ke/fhir/StructureDefinition/patient-ethnicity-extension']) &lt;= 1">extension with URL = 'https://fhir.sha.go.ke/fhir/StructureDefinition/patient-ethnicity-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.sha.go.ke/fhir/StructureDefinition/person-with-disability-extension']) &lt;= 1">extension with URL = 'https://fhir.sha.go.ke/fhir/StructureDefinition/person-with-disability-extension': maximum cardinality of 'extension' is 1</sch:assert>
