...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Practitioner/f:qualification">
      <sch:assert test="count(f:extension[@url = 'https://fhir.sha.go.ke/fhir/StructureDefinition/license-status-extension']) &lt;= 1">extension with URL = 'https://fhir.sha.go.ke/fhir/StructureDefinition/license-status-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.sha.go.ke/fhir/StructureDefinition/licensing-body-extension']) &lt;= 1">extension with URL = 'https://fhir.sha.go.ke/fhir/StructureDefinition/licensing-body-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
