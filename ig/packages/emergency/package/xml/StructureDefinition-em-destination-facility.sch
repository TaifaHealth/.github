...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Location">
      <sch:assert test="count(f:extension[@url = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/em-facility-level']) &lt;= 1">extension with URL = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/em-facility-level': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/em-emergency-centre-capability']) &lt;= 1">extension with URL = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/em-emergency-centre-capability': maximum cardinality of 'extension' is 1</sch:assert>
