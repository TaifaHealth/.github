...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      ...
      <sch:assert test="count(f:extension[@url = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/ke-emergency-ambulance-case-status']) &gt;= 1">extension with URL = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/ke-emergency-ambulance-case-status': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/ke-emergency-ambulance-case-status']) &lt;= 1">extension with URL = 'https://nshr-uat.sha.go.ke/fhir/StructureDefinition/ke-emergency-ambulance-case-status': maximum cardinality of 'extension' is 1</sch:assert>
